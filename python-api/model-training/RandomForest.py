...
# Chuyển đổi cột phân loại sang mã hóa số (One-Hot Encoding)
...
with open(os.path.join(model_deployment_path, 'random_forest.pkl'), 'wb') as file:
    pickle.dump(model, file)

print("Mô hình đã được lưu vào thư mục 'model-deployment' với tên file 'random_forest.pkl'")
